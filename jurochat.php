...
echo "<div data-role='main' class='ui-content'> "; //body pART of JQM strts here
	echo "<div id='menu'>";
		...
		echo "<a href='#' data-role='button' id='back' data-icon='back' data-inline='true' style='width:10%'>BACK</a>";
...
else
{
	...
	echo '<script>window.location="http://localhost/220_latest1/frontpage.html";</script>';
	die();
}
?>
...
$(document).ready(function(){
	$("#back").click(function(){
			...
			window.open("http://localhost/220_latest1/homepage.php?chat=true");
